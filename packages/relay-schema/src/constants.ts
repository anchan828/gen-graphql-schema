...
export const DESCRIPTIONS = {
  ...
  EDGE_TYPE: {
    TYPE: (connectionTypeName: string) => `An edge in a ${connectionTypeName}.`,
    NODE: `The item at the end of the edge.`,
  },
  CONNECTION_TYPE: {
    TYPE: (typeName: string) => `The connection type for ${typeName}`,
    TOTAL_COUNT: (typeName: string) =>
      `Identifies the total count of ${typeName} items in the connection.`,
    EDGES: (edgeTypeName: string) => `A list of ${edgeTypeName}.`,
  },
};
