...
export const DESCRIPTIONS = {
  WHERE_OPERATOR_TYPE: {
    TYPE: (typeName: string) =>
      `Query type of ${typeName} with using operators`,
    OPERATORS: {
  ...
  WHERE_OPERATOR: {
    TYPE: (typeName: string) => `${typeName} query with using operators`,
    FIELDS: {
      TYPE: (typeName: string) =>
        `Query type of ${typeName} with using operators`,
      VALUE: (typeName: string) => `Query value of ${typeName}`,
    },
  },
  WHERE_TYPE: {
    TYPE: (typeName: string) => `Query of ${typeName} with using operators`,
    FIELDS: (fieldName: string) => `Query with using ${fieldName} field`,
  },
};
